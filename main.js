...
function doHomework(subject, callback){
    alert(`Starting my ${subject} homeowrk`);
    callback()
}
...
function increase_slow_salary(base, increase){
    const new_salary = slow_additon(base, increase);
    console.log(`New Salary ${new_salary}`);
    return new_salary
}

async function async_increase_salary(base, increase){
    const new_salary = await slow_additon(base, increase);
